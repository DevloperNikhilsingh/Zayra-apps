    ...
    return (
        <>
            ...
            <div className='w-full h-[200px] bg-aboutbanner bg-cover '>
                <div className='p-14'>
                    <h1 className='text-4xl font-bold text-center font-heading'>#knowUs</h1>
                    <p className='text-sm font-semibold text-center font-body'> We’re more than a brand — we’re a team driven by passion, creativity, and customer happiness.</p>
                </div>
            </div>
            ...
            <h1 className='font-heading text-3xl text-center mt-2 underline'>Why Shop With Us</h1>
      ...
      <div className='h-[150px] bg-banner6 bg-cover bg-center'>
        <div className='w-full m-auto p-2 md:p-4 grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div className='flex flex-col justify-center items-start'>
            <h1 className='text-[14px] md:text-3xl text-black font-bold p-2 font-heading'>Sign Up For Newsletters</h1>
            <p className='text-[12px] md:text-sm text-white font-semibold p-2 font-body'>Get Email updates About our Latest Shop and <span className='text-yellow-400'>Special offers</span></p>
          </div>
          <div className='flex flex-row justify-center items-center'>
            ...
            <button className='w-[100px] h-[32px] bg-transparent border-2 border-black shadow-sm font-body'>Subscribe</button>
          </div>
        </div>
      </div>
        </>
