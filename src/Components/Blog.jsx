    ...
    return (
        ...
        {/* // BANNER */}
            <div className='w-full h-[200px] bg-blogbanner bg-cover  '>
                <div className='p-14'>
                    <h1 className='text-4xl font-bold text-center'>#readmore</h1>
                    <p className='text-sm font-semibold text-center '>Read all Case Study About our Products !</p>
                </div>
            </div>
            ...
            <div className='w-full p-4 flex flex-col gap-4'>
                ...
                <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-8 mt-8' data-aos="fade-left">
                    ...
                    <div className='right-box p-4'>
                        <h1 className='text-xl font-bold '>The cotton Jersy Zip-up Hoodie</h1>
                        <p className='mt-2 text-gray-500 text-sm font-semibold'>kickstarter man brand godard coloring book. Ractleit Westcoll selfish yrwolf Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit blanditiis fugit atque.</p>
                        <p className='text-sm font-semibold mt-5 text-gray-500 cursor-pointer'>Conntinue Reading ➜</p>
                    </div>
                </div>
                {/* BOX-2 */}
                <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-8 mt-8'data-aos="fade-right">
                    <div className='right-box p-4 hidden md:block'>
                        <h1 className='text-xl font-bold '>How to Sttyle a Quick Cuff</h1>
                        <p className='mt-2 text-gray-500 text-sm font-semibold'>kickstarter man brand godard coloring book. Ractleit Westcoll selfish yrwolf Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit blanditiis fugit atque.</p>
                        <p className='text-sm font-semibold mt-5 text-gray-500 cursor-pointer'>Conntinue Reading ➜</p>
                    </div>
                    <div className='left-box'>
                ...
                <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-8 mt-8' data-aos="fade-left">
                    ...
                    <div className='right-box p-4'>
                        <h1 className='text-xl font-bold '>Must have Skatter-Girls Item</h1>
                        <p className='mt-2 text-gray-500 text-sm font-semibold'>kickstarter Girls brand godard coloring book. Ractleit Westcoll selfish yrwolf Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit blanditiis fugit atque.</p>
                        <p className='text-sm font-semibold mt-5 text-gray-500 cursor-pointer'>Conntinue Reading ➜</p>
                    </div>
                </div>
                {/* BOX-2 */}
                <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-8 mt-8'data-aos="fade-right">
                    <div className='right-box p-4 hidden md:block'>
                        <h1 className='text-xl font-bold '>Runway-Inspired Trends</h1>
                        <p className='mt-2 text-gray-500 text-sm font-semibold'>kickstarter man brand godard coloring book. Ractleit Westcoll selfish yrwolf Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit blanditiis fugit atque.</p>
                        <p className='text-sm font-semibold mt-5 text-gray-500 cursor-pointer'>Conntinue Reading ➜</p>
                    </div>
                    <div className='left-box'>
            ...
            {/* NEWSLETTER BANNER */}
      <div className='h-[150px] bg-banner6 bg-cover bg-center mt-4'>
